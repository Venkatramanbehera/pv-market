      ...
      <div className={isOpen ? "dashboard-content-open" : "dashboard-content"}>
        ...
        <div className="dashboard-main-content">
          <div className="dashboard-page-header">
            ...
            <div className="settings-div">
              ...
              >
                ...
                <option value="uninterested">Move to uninterested list</option>
          ...
          <div className="_4-grid wf-section">
            <div
              className="new-leads module module-card blue"
              id="new-leads"
              onclick="changeCard(this, 'action')"
            >
            ...
            <div
              className="contacted module module-card"
              id="contacted"
              onclick="changeCard(this, 'contacted')"
            >
              <div className="module-header minimal">
            ...
            <div
              className="approved module module-card"
              id="approved"
              onclick="changeCard(this, 'approved')"
            >
              <div className="module-header minimal">
            ...
            <div
              className="uninterested module module-card"
              id="uninterested"
              onclick="changeCard(this, 'uninterested')"
            >
              <div className="module-header minimal">
                    ...
                    <div role="listitem" className="w-dyn-item">
                      <div className="full-customer-row">
                        ...
                        >
                          ...
                          >
                            <div className="name-truncate">Short Name</div>
                            <div style={{ marginLeft: 20 }}>1 254 221 0567</div>
                          </div>
                          <div className="address-truncate">
                            234 Grennan avenue, Texas, 02061
                          </div>
